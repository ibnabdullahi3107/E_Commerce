...
<!-- SweetAlert2 -->
<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/sweetalert2@11.0.19/dist/sweetalert2.min.css">
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11.0.19/dist/sweetalert2.all.min.js"></script>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            ...
                            @guest
                            <ul>                                
                                <li><i class="fi-rs-key"></i><a href="{{ route('login') }}">Sign In </a>  / <a href="{{ route('register') }}">Sign Up</a></li>
                            </ul>
                            @endguest
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="\"><h4 class="animated fw-900 text-brand inline-block">JABANDU VENTURES</h4></a>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Call Free</span> (+234) 70-6850-3107 </p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Babbar Kasuwa Gombe State
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+234 7068-503-107
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>jabandu@gmail.com
                            </p>
...
<script>
    ...
    window.addEventListener('show-delete-confermation', event=>{
        Swal.fire({
        title: 'Are you sure?',
...
//     window.addEventListener('successWork', event=>{
//         Swal.fire({
//         position: 'top-end',
//         icon: 'success',
