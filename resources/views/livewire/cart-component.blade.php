                                ...
                                <tbody>
                                        ...
                                        @foreach (Cart::content() as $item)
                                                <tr>
                                                    ...
                                                    <td class="action" data-title="Remove"><a href="#" wire:click.prevent="destory('{{ $item->rowId }}')" class="text-muted"><i class="fi-rs-trash"></i></a></td>
                                                </tr>
                                        @endforeach
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="#" wire:click.prevent="destoryAll()" class="text-muted"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                        </td>
                                    </tr>
                                </tbody>
