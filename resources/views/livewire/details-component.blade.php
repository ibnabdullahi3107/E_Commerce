                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            ...
                                            <figure class="border-radius-10">
                                                ...
                                                <img src="{{ asset('assets/imgs/products/' . $product->image) }}" style="height: auto; width: 100%;"  alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="button" wire:click.prevent="store({{ $product->id }}, '{{ $product->name }}', {{ $product->regular_price }})" class="button button-add-to-cart">Add to cart</button>
