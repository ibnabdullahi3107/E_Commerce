                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('admin.categories') }}" style="border-radius: 25%" class="btn btn-success float-end">All Categories</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                               ...
                               <form wire:submit.prevent="storeCategory">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" name="slug" placeholder="Enter Slug Category" wire:model="slug"/>
                                        @error('slug')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    </div>
